...
define( 'WPCACHEHOME', '/homepages/22/d799858618/htdocs/projet-2/wp-content/plugins/wp-super-cache/' );
...
define( 'DB_NAME', 'dbs189317' );

/** Utilisateur de la base de données MySQL. */
define( 'DB_USER', 'dbu310726' );

/** Mot de passe de la base de données MySQL. */
define( 'DB_PASSWORD', 'BaseDeDonneesProjet227//' );

/** Adresse de l’hébergement MySQL. */
define( 'DB_HOST', 'db5000194474.hosting-data.io' );
